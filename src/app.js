...
class App{
    ...
    initPages() {
        ...
        <div id="main">
            ...
            <div id="title">
                blacker生涯模拟器<br>
                <div style="font-size:1.5rem; font-weight:normal;">搓什么midi，走了。</div>
            </div>
            <div style="width:100%;position:fixed;top:65%;left:50%;display:flex;max-width:800px;transform:translate(-50%,0);">
                <button id="restart" class="mainbtn" style="flex:1;"><span class="iconfont">&#xe6a7;</span>立即开始</button>
        ...
        <div id="main">
            ...
            <button id="random" class="mainbtn" style="position: fixed; top: 50%; left: 50%; transform: translate(-50%, -50%);"">激情十连！</button>
                    ...
                    .forEach(talent=>{
                        ...
                        li.click(()=>{
                            if(li.hasClass('selected')) {
                                ...
                                if(this.#talentSelected.size==3) {
                                    talentPage.find('#next').text('开启blacker人生')
                                }
                            }
                        });
                    });
        ...
        <div id="main">
            ...
            <div class="btn-area">
                <button id="summary" class="mainbtn">生涯总结</button>
        ...
        <div id="main">
            ...
            <ul id="judge" class="judge">
                ...
                <li class="grade0"><span>圈龄：</span><span>3岁 早夭</span></li>
